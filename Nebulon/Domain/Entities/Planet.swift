...
struct Planet: Identifiable, Hashable {
    ...
    static let allPlanets: [Planet] = [
        Planet(id: "mercury", name: "Mercury", modelName: "Mercury.usdz", subtitle: "Closest to Sun",
        ...
        Planet(id: "venus", name: "Venus", modelName: "Venus.usdz", subtitle: "Morning Star",
        ...
        Planet(id: "earth", name: "Earth", modelName: "Earth.usdz", subtitle: "Home",
        ...
        Planet(id: "mars", name: "Mars", modelName: "Mars.usdz", subtitle: "Red Planet",
        ...
        Planet(id: "jupiter", name: "Jupiter", modelName: "Jupiter.usdz", subtitle: "Gas Giant",
        ...
        Planet(id: "saturn", name: "Saturn", modelName: "Saturn.usdz", subtitle: "Ringed Beauty",
        ...
        Planet(id: "uranus", name: "Uranus", modelName: "Uranus.usdz", subtitle: "Is Awesome",
        ...
        Planet(id: "neptune", name: "Neptune", modelName: "Neptune.usdz", subtitle: "Windiest Planet",
        ...
        Planet(id: "pluto", name: "Pluto", modelName: "Pluto.usdz", subtitle: "Planet enough for me",
